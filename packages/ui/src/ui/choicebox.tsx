...
const choiceboxItemStyles = tv({
  extend: focusStyles,
  base: [
    'bg-background [--choicebox-foreground:var(--color-primary)] [--choicebox:color-mix(in_oklab,var(--color-primary)_4%,white_96%)]',
  ...
  variants: {
    init: {
      true: [
        ...
        '[&_[slot=title]]:text-(--choicebox-foreground)',
        '[&_[slot=description]]:text-(--choicebox-foreground)',
      ],
    },
    isDisabled: {
      true: 'z-10 cursor-default opacity-50 forced-colors:text-[GrayText] [&_[slot=description]]:text-muted-foreground/70 [&_[slot=title]]:text-muted-foreground',
    },
  },
});
