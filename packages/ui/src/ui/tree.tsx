...
import { IconChevronRight } from 'ancient-icons';
...
const itemStyles = tv({
  base: [
    ...
    '[&_[slot=chevron]]:outline-hidden [&_[slot=chevron]_[data-slot=icon]]:text-muted-foreground',
    'data-has-child-rows:[--padding:0px]',
  ],
  variants: {
    isExpanded: {
      true: '[&_[slot=chevron]_[data-slot=icon]]:rotate-90 [&_[slot=chevron]_[data-slot=icon]]:text-foreground [&_[slot=chevron]_[data-slot=icon]]:transition [&_[slot=chevron]_[data-slot=icon]]:duration-200',
    },
    isFocusVisible: {
      true: 'focus:outline-hidden focus-visible:ring-1 focus-visible:ring-primary [&_[slot=chevron]_[data-slot=icon]]:text-foreground',
    },
    isDisabled: {
