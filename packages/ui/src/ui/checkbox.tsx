...
import { IconCheck, IconMinus } from 'ancient-icons';
import type {
...
const boxStyles = tv({
  base: 'inset-ring inset-ring-foreground/10 flex size-4 shrink-0 items-center justify-center rounded text-background transition *:data-[slot=icon]:size-3',
  variants: {
    isSelected: {
      false: 'bg-muted',
      true: [
