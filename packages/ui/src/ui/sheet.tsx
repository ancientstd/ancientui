...
const overlayStyles = tv({
  base: [
    'fixed top-0 left-0 isolate z-50 flex h-(--visual-viewport-height) w-full items-center justify-center bg-foreground/15 p-4 dark:bg-background/40',
  ],
  variants: {
    isBlurred: {
      true: 'bg-background/15 backdrop-blur dark:bg-background/40',
    },
    isEntering: {
...
const contentStyles = tv({
  base: 'fixed z-50 grid gap-4 border-foreground/5 bg-overlay text-overlay-foreground shadow-lg transition ease-in-out dark:border-border',
  variants: {
    isEntering: {
