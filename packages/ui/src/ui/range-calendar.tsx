                  ...
                  {(date) => (
                    <CalendarCell
                      ...
                      className={twMerge([
                        ...
                        'group/calendar-cell relative size-10 cursor-default outline-hidden [line-height:2.286rem] selection-start:rounded-s-lg data-selection-end:rounded-e-lg data-outside-month:text-muted-foreground sm:size-9 sm:text-sm',
                        ...
                        date.compare(now) === 0 &&
                          'after:-translate-x-1/2 after:pointer-events-none after:absolute after:start-1/2 after:bottom-1 after:z-10 after:size-[3px] after:rounded-full after:bg-primary selected:after:bg-primary-foreground',
                      ])}
                    >
                      {({
                        formattedDate,
