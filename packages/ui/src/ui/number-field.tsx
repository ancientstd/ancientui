...
const StepperButton = ({
  ...
  return (
    <Button
      className={composeTailwindRenderProps(
        className,
        'h-10 cursor-default pressed:text-primary-foreground text-muted-foreground group-disabled:bg-secondary/70 sm:pressed:bg-primary forced-colors:group-disabled:text-[GrayText]',
      )}
      slot={slot}
      {...props}
    >
