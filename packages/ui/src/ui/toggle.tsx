...
const toggleStyles = tv({
  ...
  variants: {
    ...
    intent: {
      plain:
        'inset-ring-0 selected:bg-secondary selected:text-secondary-foreground',
      solid: [
        'inset-ring selected:inset-ring-foreground selected:bg-foreground selected:text-background',
      ],
      outline: [
