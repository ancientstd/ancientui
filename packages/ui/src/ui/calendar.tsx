...
import { IconChevronLeft, IconChevronRight } from 'ancient-icons';
import {
  type CalendarDate,
  getLocalTimeZone,
  today,
            ...
            <CalendarCell
              ...
              className={composeRenderProps(
                ...
                (className, { isSelected, isDisabled }) =>
                  twMerge(
                    'relative flex size-10 cursor-default items-center justify-center rounded-lg text-foreground tabular-nums outline-hidden hover:bg-secondary-foreground/15 sm:size-9 sm:text-sm/6 forced-colors:text-[ButtonText] forced-colors:outline-0',
                    isSelected &&
                    ...
                    date.compare(now) === 0 &&
                      'after:-translate-x-1/2 after:pointer-events-none after:absolute after:start-1/2 after:bottom-1 after:z-10 after:size-[3px] after:rounded-full after:bg-primary selected:after:bg-primary-foreground focus-visible:after:bg-primary-foreground',
                    className,
                  ),
              )}
            />
...
const CalendarHeader = ({
  ...
  return (
    ...
    >
      ...
      <Heading
        className={twMerge(
          'mr-2 flex-1 text-left font-medium text-muted-foreground sm:text-sm',
          !isRange && 'sr-only',
          className,
        )}
      />
