...
const tooltipStyles = tv({
  ...
  variants: {
    intent: {
      ...
      inverse:
        'border-transparent bg-foreground text-background [&_.arx]:fill-foreground [&_.arx]:stroke-transparent dark:[&_.arx]:fill-white [&_.text-muted-foreground]:text-background/70 dark:[&_.text-muted-foreground]:text-foreground/70',
    },
    isEntering: {
      true: [
        'fade-in animate-in',
