...
import { IconCalendarMonth } from 'ancient-icons';
...
const DatePickerIcon = () => (
  <Button
    size="square-petite"
    intent="plain"
    className="mr-1 h-7 w-8 rounded outline-offset-0hover:bg-transparent pressed:bg-transparent **:data-[slot=icon]:text-muted-foreground"
  >
    <IconCalendarMonth
      aria-hidden
      className="ml-2 group-open:text-foreground"
    />
  </Button>
);
