...
const PaginationItem = ({
    ...
    renderListItem(
      {
        ...
        className: buttonStyles({
          ...
          size: 'small',
          className: twMerge(
            'cursor-pointer font-normal text-foreground focus-visible:border-primary focus-visible:bg-primary/10 focus-visible:ring-4 focus-visible:ring-primary/20',
            className,
          ),
        }),
        ...props,
  ...
  switch (segment) {
    ...
    case 'separator':
      return renderListItem(
        ...
        <Separator
          ...
          className="h-5 w-[1.5px] shrink-0 rotate-[14deg] bg-secondary-foreground/40"
        />,
      );
    case 'ellipsis':
      return renderListItem(
    ...
    case 'first':
      return renderPaginationIndicator(<IconChevronLeftPipe />);
    case 'last':
      return renderPaginationIndicator(<IconChevronRightPipe />);
    default:
      return renderListItem(
        {
          textValue: textValue,
