...
const tabStyles = tv({
  base: [
    'relative flex cursor-default items-center whitespace-nowrap rounded-full font-medium text-sm outline-hidden transition hover:text-foreground *:data-[slot=icon]:mr-2 *:data-[slot=icon]:size-4',
  ...
  return (
    <TabPanelPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        'flex-1 text-foreground text-sm focus-visible:outline-hidden',
      )}
    />
  );
};
